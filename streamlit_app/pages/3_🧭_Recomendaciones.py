...
with col_sel_1:
    ...
    arquetipo_filtro = st.selectbox(
        "Filtrar por arquetipo de viajero (opcional)",
        arquetipos_disponibles,
        index=0,
        help="Filtra la lista de usuarios por su arquetipo del ground truth.",
    )
...
st.markdown("### 4 · ¿Qué aprendió el modelo? · Análisis PCA de los embeddings")
